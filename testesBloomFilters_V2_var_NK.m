...
% As receitas corretas e incorretas são receitas cujo processo de
% determinação da sua categoria ficou pela etapa dos bloom filters, ou
% seja, são receitas .............
...
for a_ind = 1:length(a_values)
    for k_ind = 1:length(k_values)
        ...
        % categoria
        [BFs, k_keys, collisions_counts] = addRecipesToBloomFilters_v2(BFs, n, ks, train_data, train_categories, uniqueIngredients);
        ...
        falsos_positivos(a_ind, k_ind) = (len_tc - numRecipes);
